...
import com.crazykid.mmall.dao.*;
import com.crazykid.mmall.pojo.*;
...
import com.crazykid.mmall.vo.OrderItemVo;
import com.crazykid.mmall.vo.OrderProductVo;
import com.crazykid.mmall.vo.OrderVo;
import com.crazykid.mmall.vo.ShippingVo;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse createOrder(Integer userId, Integer shippingId) {
        ...
        //计算这个订单的总价
        ServerResponse<List<OrderItem>> serverResponse = this.getCartOtherItem(userId, cartList);
    ...
    private Long generateOrderNo() {
        ...
        return currentTime+new Random().nextInt(100)+currentTime%10;
    ...
    //判断售卖状态和库存
    private ServerResponse<List<OrderItem>> getCartOtherItem(Integer userId, List<Cart> cartList) {
    ...
    public ServerResponse getOrderCartProduct(Integer userId) {
        ...
        //从购物车中获取数据
        List<Cart> cartList = cartMapper.selectCheckedCartByUserId(userId);
        ServerResponse serverResponse = this.getCartOtherItem(userId, cartList);
        if (!serverResponse.isSuccess()) {
            return serverResponse;
        }
        List<OrderItem> orderItemList = (List<OrderItem>) serverResponse.getData();
